                ...
                <form action="../backend/user.php" method="post">
                    ...
                    <div class="md:grid gap-4 mb-4 md:grid-cols-2 md:gap-6 sm:mb-5">
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="text" name="name_user" id="name_user" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="<?php echo htmlspecialchars($user['name_user'])?>" placeholder="Type your username" required="">
                        </div>
                        ...
                        <div class="md:w-full pt-3 md:pt-0">
                            ...
                            <input type="text" name="email_user" id="email_user" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="<?php echo htmlspecialchars($user['email_user']) ?>" placeholder="Type your email" required="">
                        </div>
                        ...
                        <div class="w-full pt-3 md:pt-0">
                            ...
                            <input type="text" name="company_name_user" id="company_name_user" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="<?php 
