<div class="w-full bg-white rounded-lg shadow dark:bg-gray-800 dark:text-slate-100 p-4 md:p-6">
  <div class="flex justify-between mb-10">
    <div>
      ...
      <p class="text-base font-normal text-gray-500 dark:text-gray-400">Example Graph</p>
    </div>
    <div
...
<?php
  $file_name_graph = "Example Prediction Graph";
  $filename = "documentation/sample/example.csv";
